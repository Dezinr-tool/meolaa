 ...
 *
 * Angle is the rotation of +X around Z (incidence on the left slant face for
 * the upright XY-triangle prism extruded along Z).
 * Pass minDeg/maxDeg as a signed range (e.g. -45..-5 or 5..45) to pick a side.
 *
