...
/** DOM trigger for the pinned hero (must match App.jsx). */
export const HERO_TRIGGER = '#hero'
 ...
 *   textReveal       0.75  FUTURE slides in from left (+ fade)
...
export function createHeroTimeline({
  ...
  // ~75% → ~90%: FUTURE slides behind/through the glass into center
...
/**
 * Pin + scrub the hero timeline. Lenis-smoothed scroll feeds ScrollTrigger
 * via the global Lenis ↔ ticker bridge in App.
 */
export function attachHeroScrollTrigger(timeline, { trigger = HERO_TRIGGER } = {}) {
