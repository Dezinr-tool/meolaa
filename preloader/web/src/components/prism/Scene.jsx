...
/**
 * Extra yaw around the diamond rest pose (TETRA_REST_EULER).
 * 0 keeps point-top / point-bottom centered; OrbitControls still free-look.
 */
 ...
 * and WebGL has compiled MeshTransmissionMaterial + custom shaderMaterials.
 */
function PrismReadyReporter({ armed = false }) {
...
export default function Scene({ enableHeroRefraction = ENABLE_HERO_REFRACTION }) {
  ...
  return (
    <>
      <PrismReadyReporter
        armed={Boolean(trace?.entryPoint && ribbon && internalBeam)}
      />
